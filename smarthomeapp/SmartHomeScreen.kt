...
fun SmartHomeApp(
    ...
    Scaffold(
        ...
        NavHost(
            ...
            startDestination = SmartHomeScreen.Password.name,
            ...
            composable(route = SmartHomeScreen.Menu.name) {
                MenuScreen(
                    ...
                    onActivityButtonClicked = {
                        // Now when clicked the screen changes to the flavor screen
                        navController.navigate(SmartHomeScreen.Log.name)
                    }
                )
            }
            ...
            composable(route = SmartHomeScreen.Log.name) {
                ActivityScreen()
            }

            composable(route = SmartHomeScreen.Password.name) {
                PasswordScreen(
                    // A function calls navigate when the user clicks buttons on the start screen
